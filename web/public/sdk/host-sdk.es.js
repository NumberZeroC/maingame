...
class ApiClient {
  constructor() {
    ...
    __publicField(this, "retryCount", /* @__PURE__ */ new Map());
  ...
  setupResponseInterceptor() {
    this.instance.interceptors.response.use(
      (response) => {
        var _a;
        const requestId = (_a = response.config) == null ? void 0 : _a.requestId;
        if (requestId) {
      ...
      async (error) => {
        ...
        const requestId = (_a = error.config) == null ? void 0 : _a.requestId;
        ...
        const errorMessage = (_d = (_c = error.response) == null ? void 0 : _c.data) == null ? void 0 : _d.message;
        const messageStr = Array.isArray(errorMessage) ? errorMessage.join(", ") : errorMessage || error.message || "An error occurred";
        const apiError = {
          message: messageStr,
          statusCode: ((_e = error.response) == null ? void 0 : _e.status) || 500,
          error: (_g = (_f = error.response) == null ? void 0 : _f.data) == null ? void 0 : _g.error
        };
...
class HostSDK {
  constructor(config) {
    ...
    var _a;
    this.config = config;
    this.iframe = ((_a = config.iframeRef) == null ? void 0 : _a.current) || null;
  ...
  setStatus(status) {
    var _a, _b;
    this.status = status;
    (_b = (_a = this.config).onLifecycleChange) == null ? void 0 : _b.call(_a, status);
  }
  getStatus() {
    return this.status;
  }
  ...
  async handleGenerateText(message) {
    var _a, _b;
    const response = await api.post("/ai/text/generate", {
      gameId: this.config.gameId,
      prompt: (_a = message.payload) == null ? void 0 : _a.prompt,
      options: (_b = message.payload) == null ? void 0 : _b.options
    });
    return { result: response.data.result };
  }
  async handleGenerateImage(message) {
    var _a, _b;
  ...
  async handleStorageSave(message) {
    var _a, _b;
    await api.post(`/games/${this.config.gameId}/session/save`, {
      key: (_a = message.payload) == null ? void 0 : _a.key,
      value: (_b = message.payload) == null ? void 0 : _b.value
    });
  }
  async handleStorageLoad(message) {
    var _a, _b;
    const response = await api.get(`/games/${this.config.gameId}/session/load`, {
      params: { key: (_a = message.payload) == null ? void 0 : _a.key }
    });
    return { value: ((_b = response.data) == null ? void 0 : _b.value) ?? null };
  }
  async handleStorageClear() {
    await api.delete(`/games/${this.config.gameId}/session/clear`);
  }
  handleAnalyticsTrack(message) {
    var _a, _b;
    api.post(`/games/${this.config.gameId}/analytics`, {
      event: (_a = message.payload) == null ? void 0 : _a.event,
      data: (_b = message.payload) == null ? void 0 : _b.data
    }).catch((err) => {
      console.warn("[HostSDK] Analytics track failed:", err);
    });
  }
  async handleLeaderboardSubmit(message) {
    var _a, _b;
    const response = await api.post(`/games/${this.config.gameId}/leaderboard/submit`, {
      score: (_a = message.payload) == null ? void 0 : _a.score,
      extraData: (_b = message.payload) == null ? void 0 : _b.extraData
    });
    return response.data;
  }
  async handleLeaderboardGet(message) {
    var _a, _b;
    const response = await api.get(`/games/${this.config.gameId}/leaderboard`, {
      params: {
        type: ((_a = message.payload) == null ? void 0 : _a.type) || "global",
        limit: ((_b = message.payload) == null ? void 0 : _b.limit) || 100
      }
    });
    return response.data;
  }
  handleGameReady() {
    ...
    (_b = (_a = this.config).onGameReady) == null ? void 0 : _b.call(_a);
  }
  handleGameFinish(message) {
    var _a, _b, _c, _d, _e, _f;
    this.setStatus("finished");
    const result = {
      score: (_a = message.payload) == null ? void 0 : _a.score,
      duration: (_b = message.payload) == null ? void 0 : _b.duration,
      data: (_c = message.payload) == null ? void 0 : _c.data,
      achievements: (_d = message.payload) == null ? void 0 : _d.achievements
    };
    this.recordGameSession(result);
    (_f = (_e = this.config).onGameFinish) == null ? void 0 : _f.call(_e, result);
  }
  handleGameError(message) {
    var _a, _b;
    this.setStatus("error");
    (_b = (_a = this.config).onGameError) == null ? void 0 : _b.call(_a, new GameSDKError("GAME_ERROR", message.error || "Game error"));
  }
  handleGamePaused() {
    this.setStatus("paused");
  }
  ...
  async recordGameSession(result) {
    try {
...
//# sourceMappingURL=host-sdk.es.js.map
